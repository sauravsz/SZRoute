...
function getSchedulerState() {
  if (!globalThis.__szrouteCredentialHC) {
    globalThis.__szrouteCredentialHC = {
      initialized: false,
      sweepTimer: null,
  ...
  return globalThis.__szrouteCredentialHC;
}
...
function isCredentialHealthCheckDisabled(): boolean {
  ...
  const val = process.env.SZROUTE_DISABLE_CREDENTIAL_HEALTH_CHECK;
