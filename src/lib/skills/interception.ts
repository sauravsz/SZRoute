...
import { SZROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@szroute/open-sse/services/webSearchFallback.ts";
...
const BUILTIN_TOOL_ALIASES: Record<string, string> = {
  [SZROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME]: "web_search",
};
...
export async function handleToolCallExecution(
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      // blocks untouched, remove the SZRoute-handled tool_use blocks, and expose
