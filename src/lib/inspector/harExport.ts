 ...
 * trace out of SZRoute into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The SZRoute capture source
...
const CREATOR_NAME = "SZRoute Traffic Inspector";
