...
import { applyAntigravityClientProfileHeaders } from "@szroute/open-sse/services/antigravityClientProfile.ts";
...
} from "@szroute/open-sse/executors/antigravity.ts";
import { getCreditsMode } from "@szroute/open-sse/services/antigravityCredits.ts";
import {
  generateAntigravityRequestId,
  getAntigravitySessionId,
} from "@szroute/open-sse/services/antigravityIdentity.ts";
 ...
 * Real Claude OAuth quota windows are fetched in @szroute/open-sse/services/usage.ts.
 */
