...
function buildFactors(log: ExplainLog, targetStats: TargetStats): ExplanationFactor[] {
  ...
  factors.push({
    ...
    details: log.comboName
      ...
      : "No combo metadata was persisted, so SZRoute treated this as direct routing.",
  });
  ...
  factors.push({
    ...
    details: "Shows whether SZRoute cache or compression affected cost/latency for this route.",
  });
