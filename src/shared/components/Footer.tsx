...
const footerLinks = {
  product: [
    ...
    {
      label: "Changelog",
      href: "https://github.com/sauravsz/SZRoute/releases",
      external: true,
    },
  ],
  resources: [
    ...
    {
      label: "Help Center",
      href: "https://github.com/sauravsz/SZRoute/discussions",
      external: true,
    },
  ],
  company: [
    { label: "About", href: "https://github.com/sauravsz/SZRoute", external: true },
    { label: "Blog", href: "https://github.com/sauravsz/SZRoute/releases", external: true },
    {
      label: "Contact",
      href: "https://github.com/sauravsz/SZRoute/issues/new/choose",
      external: true,
    },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-sm text-text-muted">
            ...
            <a
              href="https://github.com/sauravsz/SZRoute/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            >
