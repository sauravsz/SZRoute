/**
 * Global Type Declarations for SZRoute
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    SZROUTE_PUBLIC_BASE_URL?: string;
    SZROUTE_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    SZROUTE_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    SZROUTE_BASE_URL?: string;
    SZROUTE_DISABLE_BACKGROUND_SERVICES?: string;
    SZROUTE_PORT?: string;
