    ...
    <div className="space-y-6 animate-spring-slide-up">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          <button onClick={handleResetToDefaults} className="btn-apple-secondary text-[12px] h-9 px-4">
            Reset Defaults
          </button>
          <button onClick={handleOpenCreateModal} className="btn-apple-primary text-[12px] h-9 px-4">
      ...
      {/* Combos 2-Up Concentric Cards Grid */}
          ...
          >
            <div className="space-y-3">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <code className="text-[12px] text-[var(--label-secondary)] font-mono block">
                      model: &quot;{combo.id}&quot;
                    </code>
                  </div>
                </div>
                ...
                {!DEFAULT_COMBOS.some((d) => d.id === combo.id) && (
                  <button
                    ...
                    className="p-1.5 rounded-xl text-[var(--system-red)] hover:bg-[var(--system-red)]/10"
                    title="Delete combo"
                  >
              ...
              <div className="space-y-1.5 pt-1">
                <div className="text-[11px] uppercase font-bold text-[var(--label-tertiary)]">
                ...
                <div className="space-y-1">
                  {combo.targets.map((t, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="flex items-center justify-between px-3.5 py-2 bg-[var(--bg-subtle)] rounded-xl text-[13px]"
                      >
                        <div className="flex items-center gap-2.5">
                          <span className="w-5 h-5 rounded-full bg-[var(--bg-card)] font-bold text-[11px] text-[var(--label-primary)] flex items-center justify-center shadow-2xs">
                            {index + 1}
                          </span>
                          ...
                          <span className="font-mono text-[12px] text-[var(--label-secondary)]">
                            {t.modelId}
                          </span>
                        </div>

                        <span className="text-[11px] text-[var(--system-blue)] font-semibold">
            ...
            <div className="pt-3 border-t border-[var(--separator)] flex items-center justify-between text-[12px]">
              <span className="text-[var(--label-secondary)]">
                In omp: <code className="font-semibold text-[var(--label-primary)]">--model {combo.id}</code>
              </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-md animate-in fade-in duration-150">
          ...
          >
            <div className="flex items-center justify-between border-b border-[var(--separator)] pb-3">
              <div>
                <div className="text-[11px] uppercase font-bold text-[var(--system-blue)]">Virtual Routing</div>
                <h3 className="text-base font-bold text-[var(--label-primary)]">Create Custom Combo</h3>
              </div>
              <button
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <label className="text-[12px] font-semibold text-[var(--label-primary)]">Combo Slug</label>
                <input
                  type="text"
                  value={newId}
              ...
              <div className="space-y-1">
                <label className="text-[12px] font-semibold text-[var(--label-primary)]">Display Name</label>
                <input
                  type="text"
                  value={newName}
            ...
            <div className="space-y-1">
              <label className="text-[12px] font-semibold text-[var(--label-primary)]">Description</label>
              <input
                type="text"
                value={newDesc}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <label className="text-[12px] font-semibold text-[var(--label-primary)]">
                ...
                <button
                  ...
                  className="text-[12px] text-[var(--system-blue)] font-semibold flex items-center gap-1"
                >
              ...
              <div className="space-y-2 max-h-40 overflow-y-auto">
                {newTargets.map((target, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-2 p-2 bg-[var(--bg-subtle)] rounded-2xl text-[12px]"
                  >
                    <span className="w-5 text-center text-[var(--label-primary)] font-bold">#{idx + 1}</span>
                    <select
                      ...
                      className="bg-[var(--bg-card)] text-[var(--label-primary)] font-semibold rounded-xl px-2.5 py-1 outline-none text-[12px] border border-[var(--separator)]"
                    >
                    ...
                    <input
                      ...
                      className="flex-1 bg-[var(--bg-card)] text-[var(--label-primary)] border border-[var(--separator)] rounded-xl px-2.5 py-1 font-mono text-[12px] outline-none"
                    />
                    ...
                    {newTargets.length > 1 && (
                      <button
                        ...
                        className="p-1 rounded-lg text-[var(--system-red)] hover:bg-[var(--system-red)]/10"
                      >
