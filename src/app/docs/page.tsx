...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "SZRoute Documentation",
    description:
      "Comprehensive docs for SZRoute AI gateway — setup, API, compression, deployment, and more.",
    type: "website",
    url: "https://szroute.online/docs",
  },
  twitter: {
    card: "summary_large_image",
    title: "SZRoute Documentation",
    description: "Comprehensive docs for SZRoute AI gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Quick Start",
    icon: "rocket_launch",
    desc: "Get SZRoute running in 3 minutes",
  },
  {
    href: "/docs/getting-started/auto-combo-guide",
    title: "Auto-Combo Guide",
    icon: "auto_awesome",
    desc: "Let SZRoute pick the best AI for you",
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">SZRoute Documentation</h1>
