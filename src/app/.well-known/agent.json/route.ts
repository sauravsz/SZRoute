 ...
 *
 * Serves the SZRoute A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the SZRoute Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "SZRoute AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 SZRoute agent skills (22 API + 20 CLI) " +
