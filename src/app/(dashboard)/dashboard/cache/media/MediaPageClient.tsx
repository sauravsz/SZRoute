...
import { IMAGE_PROVIDERS } from "@szroute/open-sse/config/imageRegistry.ts";
import { VIDEO_PROVIDERS } from "@szroute/open-sse/config/videoRegistry.ts";
import { MUSIC_PROVIDERS } from "@szroute/open-sse/config/musicRegistry.ts";
import {
...
> = {
  ...
  speech: {
    ...
    placeholder: "Hello! Welcome to SZRoute, your intelligent AI gateway...",
