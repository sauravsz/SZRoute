...
import { resolveNestedComboTargets } from "@szroute/open-sse/services/combo.ts";
    ...
    try {
      res = await fetch(internalUrl, {
        ...
        headers: {
          ...
          // SZRoute's semantic cache or other request reuse layers.
          "X-SZRoute-No-Cache": "true",
          ...(target.connectionId ? { "X-SZRoute-Connection": target.connectionId } : {}),
