...
export async function GET(request) {
  try {
    ...
    const { getQuotaMonitorSummary } = await import("@szroute/open-sse/services/quotaMonitor.ts");
    const { getActiveSessions } = await import("@szroute/open-sse/services/sessionManager.ts");
