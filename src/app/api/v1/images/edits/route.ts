...
} from "@szroute/open-sse/handlers/imageGeneration.ts";
import { getProviderCredentials, clearRecoveredProviderState } from "@/sse/services/auth";
import { parseImageModel, getImageProvider } from "@szroute/open-sse/config/imageRegistry.ts";
 ...
 *    generated through SZRoute — we then have its `{conversationId, parentMessageId}`
