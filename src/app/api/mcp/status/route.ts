...
import { getAuditStats, queryAuditEntries } from "@szroute/open-sse/mcp-server/audit";
import {
  isMcpHeartbeatOnline,
  isProcessAlive,
  readMcpHeartbeat,
  resolveMcpHeartbeatPath,
} from "@szroute/open-sse/mcp-server/runtimeHeartbeat";
import {
  getMcpHttpStatus,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const scopesEnforced = process.env.SZROUTE_MCP_ENFORCE_SCOPES === "true";
