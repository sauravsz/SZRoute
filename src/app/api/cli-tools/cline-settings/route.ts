...
// Check if SZRoute is configured as OpenAI-compatible provider
const hasSZRouteConfig = (globalState: any) => {
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasSZRoute: hasSZRouteConfig(globalState),
...
// POST - Configure Cline to use SZRoute as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_szroute";
...
// DELETE - Remove SZRoute OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "SZRoute settings removed from Cline",
    });
  } catch (error) {
