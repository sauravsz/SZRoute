...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@szroute/open-sse/services/rateLimitManager"),
      import("@szroute/open-sse/services/accountFallback"),
      import("@szroute/open-sse/services/requestDedup.ts"),
      import("@szroute/open-sse/services/quotaMonitor.ts"),
      import("@szroute/open-sse/services/sessionManager.ts"),
