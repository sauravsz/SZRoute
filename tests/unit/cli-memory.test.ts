/**
 * Tests for CLI Memory Sanitization (bin/szroute.mjs)
 *
 * Tests cover:
...
describe("CLI Memory Limit Sanitization", () => {
  /**
   * Replicate the memory sanitization logic from bin/szroute.mjs
   */
...
describe("CLI .env File Loading", () => {
  /**
   * Simulate the .env parsing logic from bin/szroute.mjs
   */
