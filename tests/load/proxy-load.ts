/**
 * SZRoute — k6 Load / Performance Test (T-5)
 *
 ...
 *   k6 run tests/load/proxy-load.js --env BASE_URL=https://llms.szroute.online
 ...
 *   - SZROUTE_API_KEY env var or --env API_KEY=... set
 */
...
const API_KEY = __ENV.API_KEY || __ENV.SZROUTE_API_KEY || "test-key";
