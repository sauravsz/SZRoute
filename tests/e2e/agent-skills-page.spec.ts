...
function makeAgentSkills(): AgentSkill[] {
  ...
  for (let i = 0; i < 22; i++) {
    skills.push({
      ...
      rawUrl: `https://raw.githubusercontent.com/example/SZRoute/main/skills/omni-skill-${i}/SKILL.md`,
      githubUrl: `https://github.com/example/SZRoute/blob/main/skills/omni-skill-${i}/SKILL.md`,
    });
  }
  for (let i = 0; i < 20; i++) {
    skills.push({
      ...
      rawUrl: `https://raw.githubusercontent.com/example/SZRoute/main/skills/cli-skill-${i}/SKILL.md`,
      githubUrl: `https://github.com/example/SZRoute/blob/main/skills/cli-skill-${i}/SKILL.md`,
    });
  }
  return skills;
}
