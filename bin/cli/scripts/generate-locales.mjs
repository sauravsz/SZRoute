...
const TRANSLATIONS = {
  ar: {
    common: {
      error: "خطأ: {message}",
      serverOffline: "خادم SZRoute غير متصل. ابدأ بالأمر: szroute serve",
      authRequired: "المصادقة مطلوبة. عيّن SZROUTE_API_KEY أو شغّل: szroute setup",
    ...
    program: {
      description: "SZRoute — جهاز توجيه الذكاء الاصطناعي مع التبديل التلقائي",
      ...
      api_key: "مفتاح API لخادم SZRoute",
      base_url: "عنوان URL الأساسي لخادم SZRoute",
      context: "سياق/ملف تعريف الخادم المستخدم في هذا الأمر",
      lang: "تعيين لغة عرض CLI (يتجاوز SZROUTE_LANG)",
    },
  },
  az: {
    common: {
      error: "Xəta: {message}",
      serverOffline: "SZRoute serveri oflayndır. Başladın: szroute serve",
      authRequired:
        "Autentifikasiya tələb olunur. SZROUTE_API_KEY təyin edin və ya işə salın: szroute setup",
    ...
    program: {
      description: "SZRoute — Avtomatik Fallback ilə Ağıllı AI Marşrutlaşdırıcısı",
      ...
      api_key: "SZRoute serveri üçün API açarı",
      base_url: "SZRoute server baza URL-i",
      context: "Bu əmr üçün server konteksti/profili",
      lang: "CLI ekran dilini təyin edin (SZROUTE_LANG-ı keçir)",
    },
  },
  bg: {
    common: {
      error: "Грешка: {message}",
      serverOffline: "Сървърът SZRoute е офлайн. Стартирайте с: szroute serve",
      authRequired:
        "Необходима е автентикация. Задайте SZROUTE_API_KEY или изпълнете: szroute setup",
    ...
    program: {
      description: "SZRoute — Интелигентен AI рутер с автоматично превключване",
      ...
      api_key: "API ключ за сървъра SZRoute",
      base_url: "Базов URL на сървъра SZRoute",
      context: "Контекст/профил на сървъра за тази команда",
      lang: "Задай език на CLI (замества SZROUTE_LANG)",
    },
  },
  cs: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server SZRoute je offline. Spusťte: szroute serve",
      authRequired: "Vyžaduje se ověření. Nastavte SZROUTE_API_KEY nebo spusťte: szroute setup",
    ...
    program: {
      description: "SZRoute — Chytrý AI router s automatickým přepínáním",
      ...
      api_key: "API klíč pro server SZRoute",
      base_url: "Základní URL serveru SZRoute",
      context: "Kontext/profil serveru pro tento příkaz",
      lang: "Nastavit jazyk CLI (přepisuje SZROUTE_LANG)",
    },
  },
  da: {
    common: {
      error: "Fejl: {message}",
      serverOffline: "SZRoute-serveren er offline. Start med: szroute serve",
      authRequired: "Godkendelse kræves. Sæt SZROUTE_API_KEY eller kør: szroute setup",
    ...
    program: {
      description: "SZRoute — Smart AI-router med automatisk fallback",
      ...
      api_key: "API-nøgle til SZRoute-serveren",
      base_url: "SZRoute-serverens basis-URL",
      context: "Server-kontekst/profil til denne kommando",
      lang: "Angiv CLI-visningssprog (tilsidesætter SZROUTE_LANG)",
    },
  },
  de: {
    common: {
      error: "Fehler: {message}",
      serverOffline: "SZRoute-Server ist offline. Starten mit: szroute serve",
      authRequired:
        "Authentifizierung erforderlich. SZROUTE_API_KEY setzen oder ausführen: szroute setup",
    ...
    program: {
      description: "SZRoute — Intelligenter AI-Router mit automatischem Fallback",
      ...
      api_key: "API-Schlüssel für den SZRoute-Server",
      base_url: "SZRoute-Server-Basis-URL",
      context: "Server-Kontext/Profil für diesen Befehl",
      lang: "CLI-Anzeigesprache festlegen (überschreibt SZROUTE_LANG)",
    },
  },
  es: {
    common: {
      error: "Error: {message}",
      serverOffline: "El servidor SZRoute está offline. Inícielo con: szroute serve",
      authRequired:
        "Autenticación requerida. Configure SZROUTE_API_KEY o ejecute: szroute setup",
    ...
    program: {
      description: "SZRoute — Router de IA inteligente con fallback automático",
      ...
      api_key: "Clave de API para el servidor SZRoute",
      base_url: "URL base del servidor SZRoute",
      context: "Contexto/perfil del servidor para este comando",
      lang: "Establecer idioma del CLI (reemplaza SZROUTE_LANG)",
    },
  },
  fa: {
    common: {
      error: "خطا: {message}",
      serverOffline: "سرور SZRoute آفلاین است. با این دستور راه‌اندازی کنید: szroute serve",
      authRequired:
        "احراز هویت لازم است. SZROUTE_API_KEY را تنظیم کنید یا اجرا کنید: szroute setup",
    ...
    program: {
      description: "SZRoute — روتر هوشمند هوش مصنوعی با fallback خودکار",
      ...
      api_key: "کلید API برای سرور SZRoute",
      base_url: "URL پایه سرور SZRoute",
      context: "زمینه/پروفایل سرور برای این دستور",
      lang: "تنظیم زبان نمایش CLI (SZROUTE_LANG را نادیده می‌گیرد)",
    },
  },
  fi: {
    common: {
      error: "Virhe: {message}",
      serverOffline: "SZRoute-palvelin on offline. Käynnistä komennolla: szroute serve",
      authRequired: "Todennus vaaditaan. Aseta SZROUTE_API_KEY tai suorita: szroute setup",
    ...
    program: {
      description: "SZRoute — Älykäs AI-reititin automaattisella fallbackilla",
      ...
      api_key: "API-avain SZRoute-palvelimelle",
      base_url: "SZRoute-palvelimen perus-URL",
      context: "Palvelimen konteksti/profiili tälle komennolle",
      lang: "Aseta CLI-näyttökieli (ohittaa SZROUTE_LANG)",
    },
  },
  fr: {
    common: {
      error: "Erreur : {message}",
      serverOffline: "Le serveur SZRoute est hors ligne. Démarrez avec : szroute serve",
      authRequired:
        "Authentification requise. Définissez SZROUTE_API_KEY ou exécutez : szroute setup",
    ...
    program: {
      description: "SZRoute — Routeur IA intelligent avec basculement automatique",
      ...
      api_key: "Clé API pour le serveur SZRoute",
      base_url: "URL de base du serveur SZRoute",
      context: "Contexte/profil du serveur pour cette commande",
      lang: "Définir la langue d'affichage du CLI (remplace SZROUTE_LANG)",
    },
  },
  hi: {
    common: {
      error: "त्रुटि: {message}",
      serverOffline: "SZRoute सर्वर ऑफलाइन है। शुरू करें: szroute serve",
      authRequired: "प्रमाणीकरण आवश्यक है। SZROUTE_API_KEY सेट करें या चलाएं: szroute setup",
    ...
    program: {
      description: "SZRoute — ऑटो फॉलबैक के साथ स्मार्ट AI राउटर",
      ...
      api_key: "SZRoute सर्वर के लिए API कुंजी",
      base_url: "SZRoute सर्वर का बेस URL",
      context: "इस कमांड के लिए सर्वर संदर्भ/प्रोफ़ाइल",
      lang: "CLI प्रदर्शन भाषा सेट करें (SZROUTE_LANG को ओवरराइड करता है)",
    },
  },
  hu: {
    common: {
      error: "Hiba: {message}",
      serverOffline: "Az SZRoute szerver offline. Indítsa el: szroute serve",
      authRequired:
        "Hitelesítés szükséges. Állítsa be az SZROUTE_API_KEY-t vagy futtassa: szroute setup",
    ...
    program: {
      description: "SZRoute — Intelligens AI útválasztó automatikus fallbackkel",
      ...
      api_key: "API kulcs az SZRoute szerverhez",
      base_url: "Az SZRoute szerver alap URL-je",
      context: "Szerverkontextus/profil ehhez a parancshoz",
      lang: "CLI megjelenítési nyelv beállítása (felülírja az SZROUTE_LANG-ot)",
    },
  },
  id: {
    common: {
      error: "Kesalahan: {message}",
      serverOffline: "Server SZRoute sedang offline. Mulai dengan: szroute serve",
      authRequired:
        "Autentikasi diperlukan. Setel SZROUTE_API_KEY atau jalankan: szroute setup",
    ...
    program: {
      description: "SZRoute — Router AI Cerdas dengan Fallback Otomatis",
      ...
      api_key: "Kunci API untuk server SZRoute",
      base_url: "URL dasar server SZRoute",
      context: "Konteks/profil server untuk perintah ini",
      lang: "Atur bahasa tampilan CLI (menggantikan SZROUTE_LANG)",
    },
  },
  it: {
    common: {
      error: "Errore: {message}",
      serverOffline: "Il server SZRoute è offline. Avviarlo con: szroute serve",
      authRequired:
        "Autenticazione richiesta. Impostare SZROUTE_API_KEY o eseguire: szroute setup",
    ...
    program: {
      description: "SZRoute — Router AI intelligente con fallback automatico",
      ...
      api_key: "Chiave API per il server SZRoute",
      base_url: "URL base del server SZRoute",
      context: "Contesto/profilo del server per questo comando",
      lang: "Imposta la lingua di visualizzazione della CLI (sovrascrive SZROUTE_LANG)",
    },
  },
  ja: {
    common: {
      error: "エラー: {message}",
      serverOffline: "SZRouteサーバーはオフラインです。起動: szroute serve",
      authRequired:
        "認証が必要です。SZROUTE_API_KEYを設定するか実行してください: szroute setup",
    ...
    program: {
      description: "SZRoute — 自動フォールバック付きスマートAIルーター",
      version: "バージョンを表示して終了",
      output: "出力形式 (table, json, jsonl, csv)",
      quiet: "重要でない出力を抑制",
      no_color: "カラー出力を無効化",
      timeout: "HTTPリクエストタイムアウト（ミリ秒）",
      api_key: "SZRouteサーバーのAPIキー",
      base_url: "SZRouteサーバーのベースURL",
      context: "このコマンドで使用するサーバーコンテキスト/プロファイル",
      lang: "CLI表示言語を設定（SZROUTE_LANGを上書き）",
    },
  },
  ko: {
    common: {
      error: "오류: {message}",
      serverOffline: "SZRoute 서버가 오프라인입니다. 시작: szroute serve",
      authRequired: "인증이 필요합니다. SZROUTE_API_KEY를 설정하거나 실행하세요: szroute setup",
    ...
    program: {
      description: "SZRoute — 자동 폴백 기능을 갖춘 스마트 AI 라우터",
      version: "버전 출력 후 종료",
      output: "출력 형식 (table, json, jsonl, csv)",
      quiet: "불필요한 출력 억제",
      no_color: "색상 출력 비활성화",
      timeout: "HTTP 요청 타임아웃(밀리초)",
      api_key: "SZRoute 서버의 API 키",
      base_url: "SZRoute 서버 기본 URL",
      context: "이 명령에 사용할 서버 컨텍스트/프로필",
      lang: "CLI 표시 언어 설정 (SZROUTE_LANG 재정의)",
    },
  },
  nl: {
    common: {
      error: "Fout: {message}",
      serverOffline: "SZRoute-server is offline. Start met: szroute serve",
      authRequired: "Authenticatie vereist. Stel SZROUTE_API_KEY in of voer uit: szroute setup",
    ...
    program: {
      description: "SZRoute — Slimme AI-router met automatische fallback",
      ...
      api_key: "API-sleutel voor de SZRoute-server",
      base_url: "Basis-URL van de SZRoute-server",
      context: "Servercontext/profiel voor dit commando",
      lang: "CLI-weergavetaal instellen (overschrijft SZROUTE_LANG)",
    },
  },
  no: {
    common: {
      error: "Feil: {message}",
      serverOffline: "SZRoute-serveren er offline. Start med: szroute serve",
      authRequired: "Autentisering kreves. Angi SZROUTE_API_KEY eller kjør: szroute setup",
    ...
    program: {
      description: "SZRoute — Smart AI-ruter med automatisk fallback",
      ...
      api_key: "API-nøkkel for SZRoute-serveren",
      base_url: "SZRoute-serverens basis-URL",
      context: "Serverkontekst/profil for denne kommandoen",
      lang: "Angi CLI-visningsspråk (overstyrer SZROUTE_LANG)",
    },
  },
  pl: {
    common: {
      error: "Błąd: {message}",
      serverOffline: "Serwer SZRoute jest offline. Uruchom: szroute serve",
      authRequired:
        "Wymagane uwierzytelnienie. Ustaw SZROUTE_API_KEY lub uruchom: szroute setup",
    ...
    program: {
      description: "SZRoute — Inteligentny router AI z automatycznym fallbackiem",
      ...
      api_key: "Klucz API dla serwera SZRoute",
      base_url: "Bazowy URL serwera SZRoute",
      context: "Kontekst/profil serwera dla tego polecenia",
      lang: "Ustaw język wyświetlania CLI (nadpisuje SZROUTE_LANG)",
    },
  },
  pt: {
    common: {
      error: "Erro: {message}",
      serverOffline: "O servidor SZRoute está offline. Inicie com: szroute serve",
      authRequired: "Autenticação necessária. Defina SZROUTE_API_KEY ou execute: szroute setup",
    ...
    program: {
      description: "SZRoute — Router de IA inteligente com fallback automático",
      ...
      api_key: "Chave de API para o servidor SZRoute",
      base_url: "URL base do servidor SZRoute",
      context: "Contexto/perfil do servidor para este comando",
      lang: "Definir idioma de apresentação do CLI (substitui SZROUTE_LANG)",
    },
  },
  ro: {
    common: {
      error: "Eroare: {message}",
      serverOffline: "Serverul SZRoute este offline. Porniți cu: szroute serve",
      authRequired: "Autentificare necesară. Setați SZROUTE_API_KEY sau rulați: szroute setup",
    ...
    program: {
      description: "SZRoute — Router AI inteligent cu fallback automat",
      ...
      api_key: "Cheie API pentru serverul SZRoute",
      base_url: "URL de bază al serverului SZRoute",
      context: "Contextul/profilul serverului pentru această comandă",
      lang: "Setează limba de afișare CLI (suprascrie SZROUTE_LANG)",
    },
  },
  ru: {
    common: {
      error: "Ошибка: {message}",
      serverOffline: "Сервер SZRoute отключён. Запустите: szroute serve",
      authRequired:
        "Требуется аутентификация. Установите SZROUTE_API_KEY или выполните: szroute setup",
    ...
    program: {
      description: "SZRoute — Умный AI-маршрутизатор с автоматическим переключением",
      ...
      api_key: "API-ключ для сервера SZRoute",
      base_url: "Базовый URL сервера SZRoute",
      context: "Контекст/профиль сервера для этой команды",
      lang: "Установить язык отображения CLI (переопределяет SZROUTE_LANG)",
    },
  },
  sk: {
    common: {
      error: "Chyba: {message}",
      serverOffline: "Server SZRoute je offline. Spustite: szroute serve",
      authRequired:
        "Vyžaduje sa overenie. Nastavte SZROUTE_API_KEY alebo spustite: szroute setup",
    ...
    program: {
      description: "SZRoute — Inteligentný AI router s automatickým prepínaním",
      ...
      api_key: "API kľúč pre server SZRoute",
      base_url: "Základná URL servera SZRoute",
      context: "Kontext/profil servera pre tento príkaz",
      lang: "Nastaviť jazyk zobrazenia CLI (prepíše SZROUTE_LANG)",
    },
  },
  sv: {
    common: {
      error: "Fel: {message}",
      serverOffline: "SZRoute-servern är offline. Starta med: szroute serve",
      authRequired: "Autentisering krävs. Ange SZROUTE_API_KEY eller kör: szroute setup",
    ...
    program: {
      ...
      api_key: "API-nyckel för SZRoute-servern",
      base_url: "SZRoute-serverns bas-URL",
      context: "Serverkontext/profil för det här kommandot",
      lang: "Ange CLI-visningsspråk (åsidosätter SZROUTE_LANG)",
    },
  },
  th: {
    common: {
      error: "ข้อผิดพลาด: {message}",
      serverOffline: "เซิร์ฟเวอร์ SZRoute ออฟไลน์ เริ่มด้วย: szroute serve",
      authRequired: "ต้องการการยืนยันตัวตน ตั้งค่า SZROUTE_API_KEY หรือรัน: szroute setup",
    ...
    program: {
      description: "SZRoute — AI Router อัจฉริยะพร้อม Auto Fallback",
      ...
      api_key: "API Key สำหรับ SZRoute server",
      base_url: "Base URL ของ SZRoute server",
      context: "บริบท/โปรไฟล์ของเซิร์ฟเวอร์สำหรับคำสั่งนี้",
      lang: "ตั้งค่าภาษาแสดงผล CLI (แทนที่ SZROUTE_LANG)",
    },
  },
  tr: {
    common: {
      error: "Hata: {message}",
      serverOffline: "SZRoute sunucusu çevrimdışı. Başlatın: szroute serve",
      authRequired:
        "Kimlik doğrulama gerekli. SZROUTE_API_KEY ayarlayın veya çalıştırın: szroute setup",
    ...
    program: {
      description: "SZRoute — Otomatik Fallback ile Akıllı AI Yönlendirici",
      ...
      api_key: "SZRoute sunucusu için API anahtarı",
      base_url: "SZRoute sunucusu temel URL'si",
      context: "Bu komut için sunucu bağlamı/profili",
      lang: "CLI görüntüleme dilini ayarla (SZROUTE_LANG'ı geçersiz kılar)",
    },
  },
  "uk-UA": {
    common: {
      error: "Помилка: {message}",
      serverOffline: "Сервер SZRoute відключено. Запустіть: szroute serve",
      authRequired:
        "Потрібна автентифікація. Встановіть SZROUTE_API_KEY або виконайте: szroute setup",
    ...
    program: {
      description: "SZRoute — Розумний AI-маршрутизатор з автоматичним перемиканням",
      ...
      api_key: "API-ключ для сервера SZRoute",
      base_url: "Базовий URL сервера SZRoute",
      context: "Контекст/профіль сервера для цієї команди",
      lang: "Встановити мову відображення CLI (замінює SZROUTE_LANG)",
    },
  },
  vi: {
    common: {
      error: "Lỗi: {message}",
      serverOffline: "Máy chủ SZRoute đang offline. Khởi động với: szroute serve",
      authRequired: "Cần xác thực. Đặt SZROUTE_API_KEY hoặc chạy: szroute setup",
    ...
    program: {
      description: "SZRoute — Bộ định tuyến AI thông minh với tự động chuyển đổi dự phòng",
      ...
      api_key: "Khóa API cho máy chủ SZRoute",
      base_url: "URL cơ sở của máy chủ SZRoute",
      context: "Bối cảnh/hồ sơ máy chủ cho lệnh này",
      lang: "Đặt ngôn ngữ hiển thị CLI (ghi đè SZROUTE_LANG)",
    },
  },
  "zh-CN": {
    common: {
      error: "错误：{message}",
      serverOffline: "SZRoute 服务器已离线。请启动：szroute serve",
      authRequired: "需要认证。请设置 SZROUTE_API_KEY 或运行：szroute setup",
    ...
    program: {
      description: "SZRoute — 具有自动故障转移的智能 AI 路由器",
      version: "打印版本并退出",
      output: "输出格式（table, json, jsonl, csv）",
      quiet: "禁止非必要输出",
      no_color: "禁用彩色输出",
      timeout: "HTTP 请求超时（毫秒）",
      api_key: "SZRoute 服务器的 API 密钥",
      base_url: "SZRoute 服务器的基础 URL",
      context: "此命令使用的服务器上下文/配置文件",
      lang: "设置 CLI 显示语言（覆盖 SZROUTE_LANG）",
    },
  },
};
