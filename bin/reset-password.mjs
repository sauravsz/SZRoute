 ...
 *   npx szroute reset-password
 *
 * Resets the admin password for SZRoute.
...
async function main() {
  ...
  if (!passwordState.exists) {
    ...
    console.error(`   Make sure SZRoute has been started at least once.`);
  ...
  console.log("   Restart SZRoute for changes to take effect.\n");
}
