...
export function isMcpDescriptionCompressionEnabled(
  ...
  if (isDisabledEnvValue(process.env.SZROUTE_MCP_COMPRESS_DESCRIPTIONS)) return false;
  if (isDisabledEnvValue(process.env.SZROUTE_MCP_DESCRIPTION_COMPRESSION)) return false;
