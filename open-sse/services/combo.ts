...
// #1731v2 guard: a provider circuit-breaker-open response (503 + `X-SZRoute-Provider-Breaker`
// header / `provider_circuit_open` error code, see providerCircuitOpenResponse) is an SZRoute
...
function isProviderCircuitOpenResult(
  ...
  const breakerHeader = result.headers?.get?.("x-szroute-provider-breaker");
