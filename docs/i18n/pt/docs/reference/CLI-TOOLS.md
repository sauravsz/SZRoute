# CLI Tools Setup Guide — SZRoute (Português (Portugal))
...
to use **SZRoute** as the unified backend, giving you centralized key management,
...
1. Open the SZRoute dashboard → **API Manager** (`/dashboard/api-manager`)
...
> **Note:** Cursor routes requests through its cloud. For SZRoute integration,
> enable **Cloud Endpoint** in SZRoute Settings and use your public domain URL.

Via GUI: **Settings → Models → OpenAI API Key**

- Base URL: `https://your-domain.com/v1`
- API Key: your SZRoute key

---

## Dashboard Auto-Configuration

The SZRoute dashboard automates configuration for most tools:

1. Go to `http://localhost:21128/dashboard/cli-tools`
...
**Droid** and **OpenClaw** are AI agents built directly into SZRoute — no installation needed.
They run as internal routes and use SZRoute's model routing automatically.

- Access: `http://localhost:21128/dashboard/agents`
...
| Error                     | Cause                   | Fix                                        |
| ------------------------- | ----------------------- | ------------------------------------------ |
| `Connection refused`      | SZRoute not running   | `pm2 start szroute`                      |
...
```bash
# Install all CLIs and configure for SZRoute (replace with your key and server URL)
