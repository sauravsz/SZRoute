...
- sebelum akun aktif habis, SZRoute menghasilkan ringkasan terstruktur yang ringkas
- setelah autentikasi memilih akun berbeda untuk sesi yang sama, SZRoute menyuntikkan
...
Jika penyedia aktif diaktifkan di `handoffProviders`, SZRoute menghasilkan ringkasan handoff
...
SZRoute menambahkan handoff yang tersimpan sebagai pesan sistem. Penyuntikan hanya terjadi setelah
...
Pada saat penyuntikan, SZRoute mengonversi muatan tersebut menjadi pesan sistem `<context_handoff>`
