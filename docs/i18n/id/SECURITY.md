...
Jika Anda menemukan kerentanan keamanan di SZRoute, harap laporkan secara bertanggung jawab:

1. **JANGAN** membuka isu GitHub yang bersifat publik
2. Gunakan [GitHub Security Advisories](https://github.com/sauravsz/SZRoute/security/advisories/new)
...
SZRoute menerapkan model keamanan berlapis:
