...
npm run dev                    # เซิร์ฟเวอร์พัฒนาอยู่ที่ http://localhost:21128
...
**SZRoute** — โปรเซสเซอร์/เราเตอร์ AI ที่รวมเป็นหนึ่ง จุดสิ้นสุดเดียว, ผู้ให้บริการ LLM มากกว่า 160 ราย, การสำรองข้อมูลอัตโนมัติ
...
SZRoute มีกลไกการล้มเหลวชั่วคราวที่เกี่ยวข้องกันสามอย่าง แต่แตกต่างกัน รักษาขอบเขตของพวกเขาแยกกันเมื่อทำการดีบักพฤติกรรมการจัดเส้นทาง ดู
...
- **การนำเข้า**: ภายนอก → ภายใน (`@/`, `@szroute/open-sse`) → เชิงสัมพันธ์
...
- **พอร์ตเริ่มต้น**: 21128 (API + แดชบอร์ดบนพอร์ตเดียวกัน)
- **ไดเรกทอรีข้อมูล**: `DATA_DIR` env var, ค่าเริ่มต้นเป็น `~/.szroute/`
