...
| `BASE_URL`                              | `http://localhost:21128`             | Server-side internal base URL                                                                             |
| `CLOUD_URL`                             | `https://szroute.dev`              | Cloud sync endpoint base URL                                                                              |
...
SZRoute implements provider-level resilience with four components:
