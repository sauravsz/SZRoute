...
npm run dev                    # Utviklingsserver på http://localhost:21128
...
**SZRoute** — enhetlig AI proxy/ruter. Ett endepunkt, 160+ LLM-leverandører, automatisk fallback.
...
SZRoute har tre relaterte, men distinkte mekanismer for midlertidig feil. Hold deres
...
- **Datakatalog**: `DATA_DIR` miljøvariabel, standard til `~/.szroute/`
