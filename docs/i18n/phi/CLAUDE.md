...
npm run dev                    # Dev server sa http://localhost:21128
...
**SZRoute** — pinagsamang AI proxy/router. Isang endpoint, 160+ LLM providers, auto-fallback.
...
Ang SZRoute ay may tatlong kaugnay ngunit magkakaibang mekanismo ng pansamantalang pagkabigo. Panatilihing hiwalay ang kanilang saklaw kapag nag-debug ng pag-uugali ng routing. Tingnan ang
...
- **Default port**: 21128 (API + dashboard sa parehong port)
- **Data directory**: `DATA_DIR` env var, default sa `~/.szroute/`
