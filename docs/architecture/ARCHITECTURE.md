---
title: "SZRoute Architecture"
version: 3.8.2
lastUpdated: 2026-05-13
---

# SZRoute Architecture
...
SZRoute can install, supervise, and route to locally-running AI tool processes
...
- SZRoute response metadata builder: `src/domain/szrouteResponseMeta.ts`
...
> SZRoute v3.8.0. For the canonical and continuously-updated list, refer to
