...
SZRoute ships as a fully installable Progressive Web App. When you access the dashboard from any mobile browser — Android (Chrome) or iOS (Safari) — you can "Add to Home Screen" and get a native app-like experience with no app store required.

## What Is a PWA?

A Progressive Web App turns the SZRoute web dashboard into something that looks and feels like a native mobile app. Once installed, it:
...
1. Open the SZRoute dashboard in Chrome: `http://YOUR_IP:21128`
2. Chrome will show an **"Add SZRoute to Home screen"** banner automatically, or:
   - Tap the **⋮** menu (three dots) → **"Add to Home screen"** or **"Install app"**
3. Confirm the prompt
4. SZRoute appears on your home screen as a standalone app

### iOS (Safari)

1. Open the SZRoute dashboard in Safari: `http://YOUR_IP:21128`
2. Tap the **Share** button (box with arrow)
3. Scroll down and tap **"Add to Home Screen"**
4. Name it (defaults to "SZRoute") and tap **Add**
5. SZRoute appears on your home screen with the app icon

### Desktop (Chrome / Edge)

1. Open the SZRoute dashboard
2. Click the **install icon** in the address bar (or ⋮ → "Install SZRoute...")
3. Confirm the prompt
4. SZRoute opens as a standalone window — no tabs, no address bar
...
SZRoute includes a service worker (`sw.js`) that provides intelligent caching:
...
SZRoute provides icons optimized for each platform:
...
```json
{
  "name": "SZRoute",
  "short_name": "SZRoute",
  "description": "SZRoute is an AI gateway for multi-provider LLMs. One endpoint for all your AI providers.",
  "start_url": "/",
  "scope": "/",
  "display": "fullscreen",
  "orientation": "any",
...
- **Cache versioning**: `szroute-pwa-v2` — bump this to force a fresh cache on update
...
When running SZRoute on Android via Termux, the PWA works seamlessly:

1. Start SZRoute in Termux: `npx szroute`
2. Open Chrome on the same phone: `http://localhost:21128`
...
Install the PWA on any device that has browser access to your SZRoute server:

- **Another phone/tablet**: Navigate to `http://PHONE_IP:21128` and install the PWA
