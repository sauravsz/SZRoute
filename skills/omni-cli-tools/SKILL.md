---
name: omni-cli-tools
description: "Manage CLI tool integrations exposed via the API. List, configure, and invoke CLI tool plugins that extend SZRoute's automation surface."
---
...
```bash
curl https://localhost:21128/api/cli-tools/backups \
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/backups \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
...
```bash
curl https://localhost:21128/api/cli-tools/runtime/{toolId} \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/guide-settings/{toolId} \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/antigravity-mitm \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/antigravity-mitm \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/antigravity-mitm \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/antigravity-mitm/alias \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X PUT https://localhost:21128/api/cli-tools/antigravity-mitm/alias \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl https://localhost:21128/api/cli-tools/claude-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/claude-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/claude-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/cline-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/cline-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/cline-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/codex-profiles \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/codex-profiles \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X PUT https://localhost:21128/api/cli-tools/codex-profiles \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/codex-profiles \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/codex-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/codex-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/codex-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/droid-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/droid-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/droid-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/kilo-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/kilo-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/kilo-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl https://localhost:21128/api/cli-tools/openclaw-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
...
```bash
curl -X POST https://localhost:21128/api/cli-tools/openclaw-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
  -H "Content-Type: application/json" \
  -d '{}'
```
...
```bash
curl -X DELETE https://localhost:21128/api/cli-tools/openclaw-settings \
  -H "Authorization: Bearer $SZROUTE_TOKEN"
```
