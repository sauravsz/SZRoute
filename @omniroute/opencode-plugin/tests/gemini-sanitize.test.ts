...
test("shouldSanitizeForGemini: gemini-cli/gemini-2.5-pro → true (real SZRoute alias)", () => {
...
test("createGeminiSanitizingFetch: composes correctly with createSZRouteFetchInterceptor (Bearer + sanitization)", async () => {
