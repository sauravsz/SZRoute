...
const dataDir = process.env.DATA_DIR || path.join(os.homedir(), ".szroute");
...
if (uninstallAlreadyInProgress) {
  ...
  try {
    execSync("npm uninstall -g szroute", {
      stdio: "inherit",
      env: {
        ...process.env,
        SZROUTE_SKIP_UNINSTALL_HOOK: "1",
      },
    });
    console.log("\n✅ SZRoute has been successfully uninstalled from your system.");
    if (!fullUninstall) {
