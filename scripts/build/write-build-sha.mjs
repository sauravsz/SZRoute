...
/**
 * write-build-sha.mjs — HEAD sentinel guard for SZRoute release builds.
 *
 * Writes SZROUTE_BUILD_SHA (or git rev-parse --short HEAD) into:
 *   - dist/BUILD_SHA
...
function resolveBuildSha() {
  if (process.env.SZROUTE_BUILD_SHA) {
    return process.env.SZROUTE_BUILD_SHA.trim();
  }
  try {
