#!/usr/bin/env node
/**
 * system-info.mjs — SZRoute System Information Reporter (#280)
 *
...
lines.push("SZRoute System Information Report");
...
const installedGlobal = run("npm list -g szroute --depth=0 2>/dev/null | grep szroute");
lines.push(`Global npm: ${installedGlobal || "not installed globally"}`);

const pm2Status = run("pm2 list 2>/dev/null | grep szroute | awk '{print $4, $10, $12}'");
...
console.log(
  `📎 Attach this file when reporting issues at: https://github.com/sauravsz/SZRoute/issues`
);
