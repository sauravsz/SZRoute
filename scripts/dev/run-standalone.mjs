...
// #2939: honor SZROUTE_MEMORY_MB (default 512), the same knob
// `szroute serve` uses, so Docker users can control the server heap under
...
const maxOldSpaceMb = resolveMaxOldSpaceMb(childEnv.SZROUTE_MEMORY_MB);
